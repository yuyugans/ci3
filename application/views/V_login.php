...
<html lang="en">
  ...
  <div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('<?php echo base_url(''); ?>aset/login/images/admin.jpg');"></div>
    <div class="contents order-2 order-md-1">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <div class="mb-4">
              <h3><b>LOGIN ADMIN</h3></b>
              <p class="mb-4">Lorem ipsum dolor sit amet elit. Sapiente sit aut eos consectetur adipisicing.</p>
            </div>
            <form action="<?php echo base_url('index.php/Admin/validasi_admin')?>" 
    method="POST">
